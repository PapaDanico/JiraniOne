...
// any route becomes an unhandledRejection that only gets logged — the
// client's request just hangs until timeout instead of receiving the 500
// from the handler below. Must be imported before any router that defines
// async handlers.
...
export function createApp(): express.Express {
  ...
  // cheap SELECT 1 and 503 if the DB is down.
